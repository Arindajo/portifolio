      ...
      <div className="max-w-6xl mx-auto">
        ...
        <header className="flex flex-col md:flex-row items-center gap-16 mb-32 py-12">
          ...
          <div className="text-center md:text-left flex-1">
            ...
            <div className="flex gap-4 justify-center md:justify-start">
              ...
              <SocialLink href="https://ug.linkedin.com/in/arinda-josephine-27281a280" icon={<svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><path d="M16 8a6 6 0 0 1 6 6v7h-4v-7a2 2 0 0 0-2-2 2 2 0 0 0-2 2v7h-4v-7a6 6 0 0 1 6-6z" /><rect width="4" height="12" x="2" y="9" /><circle cx="4" cy="4" r="2" /></svg>} />
              <SocialLink href="mailto:arindajosephine7@gmail.com" icon={<Mail size={20} />} isEmail />
            </div>
          </div>
        </header>
        ...
        <section id="about" className="mb-32">
          <div className="bg-slate-50 rounded-[3rem] p-12 md:p-20 border border-slate-100 relative overflow-hidden">
            ...
            <div className="max-w-4xl relative z-10">
              ...
              <h3 className="text-4xl md:text-5xl font-black mb-10 text-slate-900 leading-tight">
              ...
              <div className="text-slate-600 text-xl leading-relaxed font-light">
                <p>
                  ...
                  and I also do design using Figma, Adobe Photoshop, and Illustrator.
                </p>
              </div>
            </div>
          </div>
        ...
        <section id="projects" className="mb-40">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-10">
            <ProjectCard title="TrackFunds App" role="Lead Developer" status="Live" image="/trackfunds.jpg" description="A full-stack mobile application built with Flutter and Node.js for real-time expense tracking." link="https://github.com/josephineAr/ExpenseTrackerApp" />
            <ProjectCard title="APF Service Portal" role="Frontend Lead" status="Completed" image="/portal.png" description="A secure service web portal, member management and admin portal for APF Uganda" link="https://apfuganda.org" />
        ...
        <footer id="contact" className="py-20 border-t border-slate-100 flex flex-col items-center text-center">
          ...
          <a href="mailto:arindajosephine7@gmail.com" className="text-2xl font-bold text-blue-600 hover:text-slate-900 transition-colors mb-12 flex items-center gap-2">
